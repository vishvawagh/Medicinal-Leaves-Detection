...
function Home() {
    ...
    <div className="container">
      ...
      <div className="content">
        ...
        <div className="chatbot-container">
          <h3 className="chatbot-title">Hey Guys!! I'm your Assistant — ask me anything about Medicinal Plants 🧠</h3>
          ...
          <div className="chat-box">
            {chatMessages.map((msg, i) => (
              ...
              >
                <p onClick={() => msg.from === "suggestion" && sendChat(msg.text)}>{msg.text}</p>
              </div>
            ))}
            {chatLoading && <div className="chat-msg bot"><p>Assistant is typing...</p></div>}
          </div>
  ...
  <h3 className="section-title">🔍 Search and Filter Plants</h3>
  ...
  {filteredPlants.length > 0 && (
    <div className="filtered-results">
      <h4 className="results-title">Matching Plants:</h4>
